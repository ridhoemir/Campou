...
<body>
    ...
    <main>
        <h2 class="header">Daftar Jadwal Booking <?=$lapangan->Nama_Lapangan . " " . $lapangan->Nomor_Lapangan?></h2>
    <table>
        <tr>
        ...
        <?php $count = 0;foreach ($detail_penyewaan as $row) : 
            if($row['IdLapangan'] == $lapangan->IdLapangan){
                ?>
            <tr>
            ...
            <tr>
                <td colspan="9" style="width: 1520;">Lapangan ini masih kosong</td>
